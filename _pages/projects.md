...
<div id='container'>
    <img class="img-fluid rounded z-depth-1" src="{{ '/assets/img/platforms/mrs_testbed.jpg' | relative_url }}" alt="" title="Multi-robot Testbed"  class="center" style='float: right;height: 100%; width: 100%; object-fit: contain'/>
