...
<div id='container'>
    <img class="img-fluid rounded z-depth-1" src="{{ '/assets/img/reth.png' | relative_url }}" alt="" title="Resilient Extra-Terrestrial Habitats (RETH)"  class="center" style='float: right;height: 100%; width: 100%; object-fit: contain'/>
    <br>
    <p>
...
<div id='container'>
    <img class="img-fluid rounded z-depth-1" src="{{ '/assets/img/nica.png' | relative_url }}" alt="" title="Gas Leak Detecting Mobile Robot for NICA Collider"  class="center" style='float: right;height: 100%; width: 100%; object-fit: contain'/>
    <br>
    <p>
